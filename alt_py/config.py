...
class Config(object):
    ...
    def __init__(self):
        ...
        # 'foo-baz.firebaseio.com'. The value of the firebaseHost can be
        # overriden by environment variable 'ALT_FIREBASE_HOST'. The default
        ...
        # '/foobaz', the items stored would be at 'foo-baz.firebase.io/foobaz'.
        # The value of the firebasePath can be overriden by the environment
        # variable 'ALT_FIREBASE_PATH'. The default value is '/hosts'.
        if os.environ.has_key('ALT_FIREBASE_PATH'):
            self.firebase_path = os.environ.get('ALT_FIREBASE_PATH')
        else:
            self.firebase_path = '/hosts'

        # The file name to store data. This value can be overriden by the
        # environment variable 'ALT_FILENAME'. The default value is 'file.json'.
